...
import elemental2.dom.HTMLSpanElement;
...
public class ElmToTagMapping {
  ...
  static {
    ...
    HTML_ELEMENTS.put(HTMLSpanElement.class, "span");
    ...
    HTML_ELEMENTS.put(HTMLIFrameElement.class, "iframe");
    HTML_ELEMENTS.put(HTMLLinkElement.class, "link");
    HTML_ELEMENTS.put(HTMLMetaElement.class, "meta");
    HTML_ELEMENTS.put(HTMLModElement.class, "ins");
    HTML_ELEMENTS.put(HTMLModElement.class, "del");
    HTML_ELEMENTS.put(HTMLPictureElement.class, "picture");
    HTML_ELEMENTS.put(HTMLSlotElement.class, "slot");
    HTML_ELEMENTS.put(HTMLStyleElement.class, "style");
    HTML_ELEMENTS.put(HTMLTemplateElement.class, "template");
    HTML_ELEMENTS.put(HTMLTitleElement.class, "title");
    HTML_ELEMENTS.put(HTMLTableCellElement.class, "th");
  }
}
