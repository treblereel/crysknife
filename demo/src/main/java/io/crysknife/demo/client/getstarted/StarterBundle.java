...
@GWT3Resource
public interface StarterBundle extends ClientBundle {

  @Source("crysknife-single-module-starter.zip")
  @DataResource.MimeType("application/zip")
  DataResource singleModuleStarter();

  @Source("crysknife-multi-module-starter.zip")
  @DataResource.MimeType("application/zip")
  DataResource multiModuleStarter();
}
