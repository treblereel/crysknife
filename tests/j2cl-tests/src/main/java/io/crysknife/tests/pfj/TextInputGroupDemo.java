...
@Page(path = "TextInputGroupDemo")
@Singleton
@Templated("TextInputGroupDemo.html")
public class TextInputGroupDemo implements IsElement<HTMLDivElement> {

  @DataField
  TextInputGroup searchInput = searchInputGroup("Search...");

  @DataField
  TextInputGroup filterInput = filterInputGroup("Filter...");
}
