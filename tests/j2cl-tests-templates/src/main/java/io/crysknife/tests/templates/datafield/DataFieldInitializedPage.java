...
@Singleton
@Page(path = "DataFieldInitialized")
@Templated
public class DataFieldInitializedPage implements IsElement<HTMLDivElement> {
  ...
  HTMLDivElement banner = createBanner();
  ...
  private static HTMLDivElement createBanner() {
    HTMLDivElement div = (HTMLDivElement) DomGlobal.document.createElement("div");
    div.id = "initialized-banner";
    div.textContent = "Java-created banner";
    return div;
  }
}
